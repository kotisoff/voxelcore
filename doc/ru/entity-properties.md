...
Определяет, блокирует ли сущность установку блока, пересекающегося с хитбоксом сущности.

*В будущем будет также блокировать движение других сущностей.*

Значение по-умолчанию: *true*.

### Непрозрачность для лучей - *selectable*

При значении в `false` курсор будет игнорировать cущность, пропуская луч далее.
Распространяется на все использования raycast без флага include_non_selectable.
...
Определяет материал сущности (то же, что и у блоков).
